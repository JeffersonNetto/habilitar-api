...
COPY . .
WORKDIR "/src/src/Habilitar.Api"
RUN dotnet build "Habilitar.Api.csproj" -c Release -o /app/build

FROM build AS publish
RUN dotnet publish "Habilitar.Api.csproj" -c Release -o /app/publish
