...
namespace Habilitar.Core.Services
{
    ...
    {
        Task<LoginResponseViewModel> Registrar(RegisterUserViewModel registerUser);
    ...
    public class UsuarioService : ServiceBase, IUsuarioService
    {
        ...
        public async Task<LoginResponseViewModel> Registrar(RegisterUserViewModel registerUser)
        {
