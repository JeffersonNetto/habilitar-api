...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Habilitar_API.Models.Empresa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Habilitar_API.Models.Exercicio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Habilitar_API.Models.ExercicioGrupo", b =>
                {
            ...
            modelBuilder.Entity("Habilitar_API.Models.ExercicioMetrica", b =>
                {
                    b.Property<int>("ExercicioId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Habilitar_API.Models.Funcao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Habilitar_API.Models.Grupo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Habilitar_API.Models.Intervalo", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
            ...
            modelBuilder.Entity("Habilitar_API.Models.LogAcesso", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Habilitar_API.Models.LogErro", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Habilitar_API.Models.Meta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Habilitar_API.Models.Metrica", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
            ...
            modelBuilder.Entity("Habilitar_API.Models.PacienteMeta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Habilitar_API.Models.PacienteMetaDiaria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Habilitar_API.Models.PacienteMetaDiariaLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Habilitar_API.Models.Perfil", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Habilitar_API.Models.PerfilFuncao", b =>
                {
            ...
            modelBuilder.Entity("Habilitar_API.Models.Pessoa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Habilitar_API.Models.Unidade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Habilitar_API.Models.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Habilitar_API.Models.UsuarioPerfil", b =>
                {
                    b.Property<int>("UsuarioId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Habilitar_API.Models.ExercicioGrupo", b =>
                {
                    b.HasOne("Habilitar_API.Models.Exercicio", "Exercicio")
                        .WithMany("ExercicioGrupo")
                        .HasForeignKey("ExercicioId")
                        .HasConstraintName("FK_ExercicioGrupo_Exercicio")
                        .IsRequired();

                    b.HasOne("Habilitar_API.Models.Grupo", "Grupo")
                        .WithMany("ExercicioGrupo")
            ...
            modelBuilder.Entity("Habilitar_API.Models.ExercicioMetrica", b =>
                {
                    ...
                    b.HasOne("Habilitar_API.Models.Metrica", "Metrica")
                        .WithMany("ExercicioMetrica")
            ...
            modelBuilder.Entity("Habilitar_API.Models.LogAcesso", b =>
                {
                    b.HasOne("Habilitar_API.Models.Usuario", "Usuario")
                        .WithMany("LogAcesso")
            ...
            modelBuilder.Entity("Habilitar_API.Models.Meta", b =>
                {
                    b.HasOne("Habilitar_API.Models.Empresa", "Empresa")
                        .WithMany("Meta")
                    ...
                    b.HasOne("Habilitar_API.Models.Usuario", "Fisioterapeuta")
                        .WithMany("MetaFisioterapeuta")
                        .HasForeignKey("FisioterapeutaId")
                        .HasConstraintName("FK_Meta_Fisioterapeuta");

                    b.HasOne("Habilitar_API.Models.Intervalo", "Intervalo")
                        .WithMany("Meta")
            ...
            modelBuilder.Entity("Habilitar_API.Models.PacienteMeta", b =>
                {
                    ...
                    b.HasOne("Habilitar_API.Models.Meta", "Meta")
                        .WithMany("PacienteMeta")
                    ...
                    b.HasOne("Habilitar_API.Models.Pessoa", "Pessoa")
                        .WithMany("PacienteMeta")
            ...
            modelBuilder.Entity("Habilitar_API.Models.PacienteMetaDiaria", b =>
                {
                    b.HasOne("Habilitar_API.Models.PacienteMeta", "PacienteMeta")
            ...
            modelBuilder.Entity("Habilitar_API.Models.PacienteMetaDiariaLog", b =>
                {
                    b.HasOne("Habilitar_API.Models.PacienteMetaDiaria", "PacienteMetaDiaria")
            ...
            modelBuilder.Entity("Habilitar_API.Models.PerfilFuncao", b =>
                {
                    b.HasOne("Habilitar_API.Models.Funcao", "Funcao")
                        .WithMany("PerfilFuncao")
                        .HasForeignKey("FuncaoId")
                        .HasConstraintName("FK_PerfilFuncao_Funcao")
                        .IsRequired();

                    b.HasOne("Habilitar_API.Models.Perfil", "Perfil")
                        .WithMany("PerfilFuncao")
            ...
            modelBuilder.Entity("Habilitar_API.Models.Usuario", b =>
                {
                    ...
                    b.HasOne("Habilitar_API.Models.Unidade", "Unidade")
                        .WithMany("Usuario")
